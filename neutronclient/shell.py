...
from neutronclient.neutron.v2_0.lb.v2 import tlscertificate as lbaas_tlscertificate
...
from neutronclient.neutron.v2_0.uos.vpn import pptpvpn
from neutronclient.neutron.v2_0.uos.vpn import openvpn
from neutronclient.neutron.v2_0.uos import uoscmd
from neutronclient.neutron.v2_0.uos.vpn import vpnuser
...
from neutronclient.neutron.v2_0.tunnel import tunnel_connection
from neutronclient.neutron.v2_0.tunnel import tunnel
from neutronclient.neutron.v2_0.tunnel import target_network
...
from neutronclient.neutron.v2_0.vm import service_type
from neutronclient.neutron.v2_0.vm import vnf
from neutronclient.neutron.v2_0.vm import vnfd
...
COMMAND_V2 = {
    ...
    'uos-vpnuser-create': vpnuser.CreateVpnUser,
    'uos-vpnuser-list': vpnuser.ListVpnUser,
    'uos-vpnuser-update': vpnuser.UpdateVpnUser,
    'uos-vpnuser-show': vpnuser.ShowVpnUser,
    'uos-vpnuser-delete': vpnuser.DeleteVpnUser,
    'uos-pptpvpn-create': pptpvpn.CreateVpnPptp,
    'uos-pptpvpn-list': pptpvpn.ListVpnPptp,
    'uos-pptpvpn-update': pptpvpn.UpdateVpnPptp,
    'uos-pptpvpn-show': pptpvpn.ShowVpnPptp,
    'uos-pptpvpn-delete': pptpvpn.DeleteVpnPptp,
    'uos-openvpn-create': openvpn.CreateOpenVPN,
    'uos-openvpn-list': openvpn.ListOpenVPN,
    'uos-openvpn-update': openvpn.UpdateOpenVPN,
    'uos-openvpn-show': openvpn.ShowOpenVPN,
    'uos-openvpn-delete': openvpn.DeleteOpenVPN,
    'uos-resource-list': uoscmd.ListResources,
    'uos-router-show': uoscmd.ShowRouterInterfaceDetailWithName,
    'uos-ratelimit-update': uoscmd.UpdateRateLimit,
    'uos-pf-add': uoscmd.AddPortFD,
    'uos-pf-delete': uoscmd.DelPortFD,
    'uos-fip-router-associate': uoscmd.AssociateFipRouter,
    'uos-swap-router': uoscmd.SwapRouter,
    'uos-change-router2ha': uoscmd.ChangeRouter2HA,
    'uos-change-router2nonha': uoscmd.ChangeRouter2NonHA,
    'uos-agent-ping': uoscmd.PingAgent,
    'agent-create': agent.CreateAgent,
    'uos-registerno-update': uoscmd.UpdateFipRegisterNo,
    'uos-get-fip-usage': uoscmd.GetFipUsage,
    'uos-resource-counter': uoscmd.ResourceCounter,
    'uos-list-counter': uoscmd.ListCounter,
    ...
    'lbaas-loadbalancerlistener-list': lbaas_listener.ListLoadBalancerListener,
    ...
    'lbaas-listenerl7policy-list': lbaas_l7policy.ListListenerL7Policy,
    ...
    'lbaas-tlscertificate-list': lbaas_tlscertificate.ListTLSCertificate,
    'lbaas-tlscertificate-show': lbaas_tlscertificate.ShowTLSCertificate,
    'lbaas-tlscertificate-create': lbaas_tlscertificate.CreateTLSCertificate,
    'lbaas-tlscertificate-update': lbaas_tlscertificate.UpdateTLSCertificate,
    'lbaas-tlscertificate-delete': lbaas_tlscertificate.DeleteTLSCertificate,
    'tunnel-list': tunnel.ListTunnel,
    'tunnel-show': tunnel.ShowTunnel,
    'tunnel-create': tunnel.CreateTunnel,
    'tunnel-update': tunnel.UpdateTunnel,
    'tunnel-delete': tunnel.DeleteTunnel,
    'tunnel-connection-list': tunnel_connection.ListTunnelConnection,
    'tunnel-connection-show': tunnel_connection.ShowTunnelConnection,
    'tunnel-connection-create': tunnel_connection.CreateTunnelConnection,
    'tunnel-connection-update': tunnel_connection.UpdateTunnelConnection,
    'tunnel-connection-delete': tunnel_connection.DeleteTunnelConnection,
    'tunnel-target-network-list': target_network.ListTargetNetwork,
    'tunnel-target-network-show': target_network.ShowTargetNetwork,
    'tunnel-target-network-create': target_network.CreateTargetNetwork,
    'tunnel-target-network-update': target_network.UpdateTargetNetwork,
    'tunnel-target-network-delete': target_network.DeleteTargetNetwork,
    ...
    # changzhi
    'service-type-list': service_type.ListServiceType,
